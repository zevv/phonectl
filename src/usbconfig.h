 ...
 */
#define  USB_CFG_VENDOR_ID       0x8c, 0x19
 ...
 */
#define USB_CFG_VENDOR_NAME     'z', 'e', 'v', 'v'
 ...
 * details. 
 */
#define USB_CFG_DEVICE_NAME     'p', 'h', 'o', 'n', 'e', 'c', 't', 'l'
...
#define USB_CFG_INTERFACE_SUBCLASS  1       /* no boot interface */
#define USB_CFG_INTERFACE_PROTOCOL  1       /* no protocol */
/* See USB specification if you want to conform to an existing device class or
 * protocol.
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    0x51  /* total length of report descriptor */
